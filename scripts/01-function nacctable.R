nacc.table<-function(dat){
  ...
  c6=c(n1[3],f1.n[,3],r1.n[,3],p1.n[,3],e1.n[,3])
  c7=c(NA,f1[,3],r1[,3],p1[,3],e1[,3])
  
  m0=cbind(c1,c2,c3,c4,c5,c6,c7)
  m1=rownames(m0)
  ...
  mat1=cbind(m2[,1], blank.col, m2[,2:3], blank.col, m2[,4:5], blank.col, m2[,6:7])
  rownames(mat1)=c("N","---",m1[2:3],"---",m1[4:6],"---",m1[7:8],"---",m1[9:10])
  colnames(mat1)=c("Full Sample","|","censored N","p","|","AD progression N","p","|","deceased N","p")
  mat1}
